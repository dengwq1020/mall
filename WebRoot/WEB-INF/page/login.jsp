...
<html>
	...
	<head>
		...
		<script src="js/jquery190.js" type="text/javascript" charset="utf-8"></script>
		<script src="js/login.js" type="text/javascript" charset="utf-8"></script>
	</head>

	<body>
		<h1>欢迎<sup>V2017</sup></h1>
						...
						<ul class="reg_form" id="reg-ul">
							...
							<li>
								...
								<div class="inputOuter2">
									<input type="text" id="user" name="user" maxlength="16" class="inputstyle2" placeholder="请输入注册用户名"/>
								</div>
							...
							<li>
								...
								<div class="inputOuter2">
									<input type="password" id="passwd" name="passwd" maxlength="16" class="inputstyle2" placeholder="请输入密码"/>
								</div>
							...
							<li>
								...
								<div class="inputOuter2">
									...
									<input type="text" id="qq" name="qq" maxlength="10" class="inputstyle2" placeholder="请输入QQ号码"/>
								</div>
